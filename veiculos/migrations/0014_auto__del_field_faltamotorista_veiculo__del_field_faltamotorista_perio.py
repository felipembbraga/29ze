...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FaltaMotorista.veiculo'
        db.delete_column(u'veiculos_faltamotorista', 'veiculo_id')

        # Deleting field 'FaltaMotorista.periodo'
        db.delete_column(u'veiculos_faltamotorista', 'periodo')

        # Adding field 'FaltaMotorista.motorista'
        db.add_column(u'veiculos_faltamotorista', 'motorista',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['veiculos.Motorista']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FaltaMotorista.veiculo'
        db.add_column(u'veiculos_faltamotorista', 'veiculo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['veiculos.VeiculoAlocado']),
                      keep_default=False)

        # Adding field 'FaltaMotorista.periodo'
        db.add_column(u'veiculos_faltamotorista', 'periodo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'FaltaMotorista.motorista'
        db.delete_column(u'veiculos_faltamotorista', 'motorista_id')
    ...
    models = {
        ...
        u'veiculos.faltamotorista': {
            'Meta': {'object_name': 'FaltaMotorista'},
            'cronograma': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['veiculos.CronogramaVeiculo']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'motorista': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['veiculos.Motorista']"})
        },
