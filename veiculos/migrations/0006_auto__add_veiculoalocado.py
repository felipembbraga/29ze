...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VeiculoAlocado'
        db.create_table(u'veiculos_veiculoalocado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('veiculo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['veiculos.Veiculo'])),
            ('perfil', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['veiculos.PerfilVeiculo'])),
        ...
        db.send_create_signal(u'veiculos', ['VeiculoAlocado'])


    def backwards(self, orm):
        # Deleting model 'VeiculoAlocado'
        db.delete_table(u'veiculos_veiculoalocado')
    ...
    models = {
        ...
        u'veiculos.veiculoalocado': {
            'Meta': {'object_name': 'VeiculoAlocado'},
            'equipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['eleicao.Equipe']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_votacao': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['eleicao.LocalVotacao']", 'null': 'True', 'blank': 'True'}),
