...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CronogramaVeiculo.dia_montagem'
        db.add_column(u'veiculos_cronogramaveiculo', 'dia_montagem',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CronogramaVeiculo.dia_montagem'
        db.delete_column(u'veiculos_cronogramaveiculo', 'dia_montagem')
