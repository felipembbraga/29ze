...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Motorista.veiculo'
        db.alter_column(u'veiculos_motorista', 'veiculo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['veiculos.Veiculo']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Motorista.veiculo'
        raise RuntimeError("Cannot reverse this migration. 'Motorista.veiculo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Motorista.veiculo'
        db.alter_column(u'veiculos_motorista', 'veiculo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['veiculos.Veiculo']))
