...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VeiculoSelecionado.requisitado_vistoria'
        db.add_column(u'veiculos_veiculoselecionado', 'requisitado_vistoria',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VeiculoSelecionado.requisitado_vistoria'
        db.delete_column(u'veiculos_veiculoselecionado', 'requisitado_vistoria')
    ...
    models = {
        ...
        u'veiculos.veiculoalocado': {
            ...
            'veiculo': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['veiculos.Veiculo']", 'unique': 'True'})
        },
