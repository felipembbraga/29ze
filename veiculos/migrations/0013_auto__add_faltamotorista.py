...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FaltaMotorista'
        db.create_table(u'veiculos_faltamotorista', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('veiculo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['veiculos.VeiculoAlocado'])),
            ('cronograma', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['veiculos.CronogramaVeiculo'])),
            ('periodo', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'veiculos', ['FaltaMotorista'])


    def backwards(self, orm):
        # Deleting model 'FaltaMotorista'
        db.delete_table(u'veiculos_faltamotorista')
    ...
    models = {
        ...
        u'veiculos.faltamotorista': {
            ...
            'veiculo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['veiculos.VeiculoAlocado']"})
        },
