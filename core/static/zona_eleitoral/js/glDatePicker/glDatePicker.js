	...
	var glDatePicker = (function() {
		...
		function glDatePicker(element, userOptions) {
			...
			options.firstDate = (new Date((options.firstDate || options.selectedDate)))._first();
                       ...
                       // if (el.val())
                        //    options.selectedDate = options.firstDate = new Date(moment(el.val(), 'DD/MM/YYYY').format('MM/DD/YYYY'));
			...
			show: function() {
				...
				$.each($('.gldp-el').not(this.el), function(i, o) {
					if(o.length) { o.options.onHide(o.calendar) ; }
                                ...
                                if (this.el.val())
                                {
                                    this.options.selectedDate = this.options.firstDate = new Date(moment(this.el.val(), 'DD/MM/YYYY').format('MM/DD/YYYY'));    
                                    this.render();                  
                                }
