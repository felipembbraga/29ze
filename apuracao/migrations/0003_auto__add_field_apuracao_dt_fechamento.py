...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Apuracao.dt_fechamento'
        db.add_column(u'apuracao_apuracao', 'dt_fechamento',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Apuracao.dt_fechamento'
        db.delete_column(u'apuracao_apuracao', 'dt_fechamento')
